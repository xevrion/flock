// Type definitions for every JSON message exchanged over the WebSocket, in both
// directions. The server keeps an identical copy of these types so the two ends
// agree on the protocol without depending on each other at runtime.
